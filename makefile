docs/index.html: docs/ assets/index.md
	cd assets && \
	pandoc index.md -H include.html --no-highlight --metadata pagetitle='An Investigation on Kripke-style Modal Type Theories ' -t html --css styling.css -o ../docs/index.html
