...
du_toVec_26 ::
  ...
  MAlonzo.Code.Data.Vec.Base.T_Vec_28
du_toVec_26 v0
  = coe MAlonzo.Code.Data.Vec.Base.du_tabulate_436 (coe v0)
...
du_toList_34 ::
  ...
  (MAlonzo.Code.Data.Fin.Base.T_Fin_6 -> AgdaAny) -> [AgdaAny]
du_toList_34 v0
  = coe MAlonzo.Code.Data.List.Base.du_tabulate_400 (coe v0)
...
du_fromList_38 ::
  [AgdaAny] -> MAlonzo.Code.Data.Fin.Base.T_Fin_6 -> AgdaAny
du_fromList_38 = coe MAlonzo.Code.Data.List.Base.du_lookup_410
-- Data.Vec.Functional.[]
d_'91''93'_40 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () -> MAlonzo.Code.Data.Fin.Base.T_Fin_6 -> AgdaAny
...
d_length_58 ::
  ...
  () ->
  Integer ->
  (MAlonzo.Code.Data.Fin.Base.T_Fin_6 -> AgdaAny) -> Integer
...
du_head_64 ::
  (MAlonzo.Code.Data.Fin.Base.T_Fin_6 -> AgdaAny) -> AgdaAny
du_head_64 v0 = coe v0 (coe MAlonzo.Code.Data.Fin.Base.C_zero_10)
...
du_insert_86 v0 v1 v2 v3
  = case coe v1 of
      ...
      MAlonzo.Code.Data.Fin.Base.C_suc_16 v5
        -> case coe v3 of
             MAlonzo.Code.Data.Fin.Base.C_zero_10 -> coe du_head_64 (coe v0)
...
du_remove_122 v0 v1 v2
  = coe
      v1
      (coe MAlonzo.Code.Data.Fin.Base.du_punchIn_508 (coe v0) (coe v2))
...
du_updateAt_130 v0 v1 v2 v3
  = case coe v0 of
      ...
      MAlonzo.Code.Data.Fin.Base.C_suc_16 v5
        -> case coe v3 of
             MAlonzo.Code.Data.Fin.Base.C_zero_10 -> coe du_head_64 (coe v2)
             MAlonzo.Code.Data.Fin.Base.C_suc_16 v7
               -> coe
...
du__'43''43'__176 v0 v1 v2 v3
  = coe
      ...
      (coe MAlonzo.Code.Data.Fin.Base.du_splitAt_202 (coe v0) (coe v3))
...
du_concat_190 v0 v1 v2
  = coe
      ...
      (coe MAlonzo.Code.Data.Fin.Base.du_quotRem_230 (coe v0) (coe v2))
...
du_drop_302 v0 v1 v2
  = coe
      v1
      (coe
         MAlonzo.Code.Data.Fin.Base.du__'8593''691'__102 (coe v0) (coe v2))
...
du_reverse_312 v0 v1 v2
  = coe
      v1 (MAlonzo.Code.Data.Fin.Base.d_opposite_474 (coe v0) (coe v2))
...
du_last_324 ::
  ...
  (MAlonzo.Code.Data.Fin.Base.T_Fin_6 -> AgdaAny) -> AgdaAny
du_last_324 v0 v1
  = coe v1 (MAlonzo.Code.Data.Fin.Base.d_fromℕ_58 (coe v0))
