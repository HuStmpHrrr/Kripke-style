...
du__'8759''691''8322'__24 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      v5 v6
-- Sublist
d_Sublist_27 a0 a1 a2 a3 a4 a5 a6 = ()
...
du_refl_90
  = let v0
          = coe
              MAlonzo.Code.Relation.Binary.PropositionalEquality.Properties.du_setoid_404 in
    coe
...
data T_Separation_172
  = C_Separation'46'constructor_3237 [AgdaAny]
                                     MAlonzo.Code.Data.List.Relation.Binary.Sublist.Heterogeneous.Core.T_Sublist_26
                                     MAlonzo.Code.Data.List.Relation.Binary.Sublist.Heterogeneous.Core.T_Sublist_26
                                     MAlonzo.Code.Data.List.Relation.Binary.Sublist.Heterogeneous.T_Disjoint_130
...
d_inflation_196 v0
  = case coe v0 of
      C_Separation'46'constructor_3237 v1 v2 v3 v4 -> coe v1
...
d_separator'8321'_198 v0
  = case coe v0 of
      C_Separation'46'constructor_3237 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Data.List.Relation.Binary.Sublist.Propositional.Separation.separator₂
...
d_separator'8322'_200 v0
  = case coe v0 of
      C_Separation'46'constructor_3237 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_disjoint_206 v0
  = case coe v0 of
      C_Separation'46'constructor_3237 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_'91''93''45'Sep_208
  = coe
      C_Separation'46'constructor_3237
...
du__'8759''8345''45'Sep__222 v0 v1
  = case coe v1 of
      C_Separation'46'constructor_3237 v2 v3 v4 v5
        -> coe
             C_Separation'46'constructor_3237
             (coe
