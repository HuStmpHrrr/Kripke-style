...
data T_IsSurjection_162
  = C_IsSurjection'46'constructor_5483 T_IsCongruent_22
...
d_isCongruent_170 v0
  = case coe v0 of
      C_IsSurjection'46'constructor_5483 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_172 v0
  = case coe v0 of
      C_IsSurjection'46'constructor_5483 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_242 v0
  = case coe v0 of
      C_IsBijection'46'constructor_7739 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isCongruent_324 v0
  = case coe v0 of
      C_IsLeftInverse'46'constructor_11245 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsRightInverse_390
  = C_IsRightInverse'46'constructor_14103 T_IsCongruent_22
                                          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny)
...
d_isCongruent_402 v0
  = case coe v0 of
      C_IsRightInverse'46'constructor_14103 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isRightInverse_544 v0
  = coe
      C_IsRightInverse'46'constructor_14103
      (coe d_isCongruent_324 (coe d_isLeftInverse_478 (coe v0)))
      (coe d_cong'8322'_326 (coe d_isLeftInverse_478 (coe v0)))
...
data T_IsBiEquivalence_554
  = C_IsBiEquivalence'46'constructor_20621 T_IsCongruent_22
                                           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_f'45'isCongruent_568 v0
  = case coe v0 of
      C_IsBiEquivalence'46'constructor_20621 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_cong'8322'_570 v0
  = case coe v0 of
      C_IsBiEquivalence'46'constructor_20621 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiEquivalence.cong₃
d_cong'8323'_572 ::
  T_IsBiEquivalence_554 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong'8323'_572 v0
  = case coe v0 of
      C_IsBiEquivalence'46'constructor_20621 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsBiInverse_636
  = C_IsBiInverse'46'constructor_24463 T_IsCongruent_22
                                       (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny)
...
d_f'45'isCongruent_654 v0
  = case coe v0 of
      C_IsBiInverse'46'constructor_24463 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
