...
data T_JoinSemilattice_14
  = C_JoinSemilattice'46'constructor_231 (AgdaAny ->
                                          AgdaAny -> AgdaAny)
...
d__'8744'__38 v0
  = case coe v0 of
      C_JoinSemilattice'46'constructor_231 v4 v5 -> coe v4
...
d_isJoinSemilattice_40 v0
  = case coe v0 of
      C_JoinSemilattice'46'constructor_231 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_BoundedJoinSemilattice_96
  = C_BoundedJoinSemilattice'46'constructor_1863 (AgdaAny ->
                                                  AgdaAny -> AgdaAny)
                                                 AgdaAny
...
d__'8744'__122 v0
  = case coe v0 of
      C_BoundedJoinSemilattice'46'constructor_1863 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BoundedJoinSemilattice.⊥
d_'8869'_124 :: T_BoundedJoinSemilattice_96 -> AgdaAny
d_'8869'_124 v0
  = case coe v0 of
      C_BoundedJoinSemilattice'46'constructor_1863 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBoundedJoinSemilattice_126 v0
  = case coe v0 of
      C_BoundedJoinSemilattice'46'constructor_1863 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_joinSemilattice_174 v0
  = coe
      C_JoinSemilattice'46'constructor_231 (d__'8744'__122 (coe v0))
      (MAlonzo.Code.Relation.Binary.Lattice.Structures.d_isJoinSemilattice_120
         (coe d_isBoundedJoinSemilattice_126 (coe v0)))
...
data T_MeetSemilattice_188
  = C_MeetSemilattice'46'constructor_3687 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
...
d__'8743'__212 v0
  = case coe v0 of
      C_MeetSemilattice'46'constructor_3687 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isMeetSemilattice_214 v0
  = case coe v0 of
      C_MeetSemilattice'46'constructor_3687 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_BoundedMeetSemilattice_270
  = C_BoundedMeetSemilattice'46'constructor_5319 (AgdaAny ->
                                                  AgdaAny -> AgdaAny)
                                                 AgdaAny
...
d__'8743'__296 v0
  = case coe v0 of
      C_BoundedMeetSemilattice'46'constructor_5319 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BoundedMeetSemilattice.⊤
d_'8868'_298 :: T_BoundedMeetSemilattice_270 -> AgdaAny
d_'8868'_298 v0
  = case coe v0 of
      C_BoundedMeetSemilattice'46'constructor_5319 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBoundedMeetSemilattice_300 v0
  = case coe v0 of
      C_BoundedMeetSemilattice'46'constructor_5319 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_meetSemilattice_348 v0
  = coe
      C_MeetSemilattice'46'constructor_3687 (d__'8743'__296 (coe v0))
      (MAlonzo.Code.Relation.Binary.Lattice.Structures.d_isMeetSemilattice_266
         (coe d_isBoundedMeetSemilattice_300 (coe v0)))
...
data T_Lattice_362
  = C_Lattice'46'constructor_7199 (AgdaAny -> AgdaAny -> AgdaAny)
...
d__'8744'__388 v0
  = case coe v0 of
      C_Lattice'46'constructor_7199 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.Lattice._∧_
d__'8743'__390 :: T_Lattice_362 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__390 v0
  = case coe v0 of
      C_Lattice'46'constructor_7199 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isLattice_392 v0
  = case coe v0 of
      C_Lattice'46'constructor_7199 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_joinSemilattice_450 v0
  = coe
      C_JoinSemilattice'46'constructor_231 (d__'8744'__388 (coe v0))
      (coe
         MAlonzo.Code.Relation.Binary.Lattice.Structures.du_isJoinSemilattice_334
         (coe d_isLattice_392 (coe v0)))
...
du_meetSemilattice_452 v0
  = coe
      C_MeetSemilattice'46'constructor_3687 (d__'8743'__390 (coe v0))
      (coe
         MAlonzo.Code.Relation.Binary.Lattice.Structures.du_isMeetSemilattice_336
         (coe d_isLattice_392 (coe v0)))
...
data T_DistributiveLattice_466
  = C_DistributiveLattice'46'constructor_9595 (AgdaAny ->
                                               AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny -> AgdaAny)
...
d__'8744'__492 v0
  = case coe v0 of
      C_DistributiveLattice'46'constructor_9595 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.DistributiveLattice._∧_
d__'8743'__494 ::
  T_DistributiveLattice_466 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__494 v0
  = case coe v0 of
      C_DistributiveLattice'46'constructor_9595 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isDistributiveLattice_496 v0
  = case coe v0 of
      C_DistributiveLattice'46'constructor_9595 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_lattice_506 v0
  = coe
      C_Lattice'46'constructor_7199 (d__'8744'__492 (coe v0))
...
data T_BoundedLattice_580
  = C_BoundedLattice'46'constructor_12089 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny -> AgdaAny) AgdaAny AgdaAny
...
d__'8744'__610 v0
  = case coe v0 of
      C_BoundedLattice'46'constructor_12089 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BoundedLattice._∧_
d__'8743'__612 ::
  T_BoundedLattice_580 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__612 v0
  = case coe v0 of
      C_BoundedLattice'46'constructor_12089 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BoundedLattice.⊤
d_'8868'_614 :: T_BoundedLattice_580 -> AgdaAny
d_'8868'_614 v0
  = case coe v0 of
      C_BoundedLattice'46'constructor_12089 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BoundedLattice.⊥
d_'8869'_616 :: T_BoundedLattice_580 -> AgdaAny
d_'8869'_616 v0
  = case coe v0 of
      C_BoundedLattice'46'constructor_12089 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBoundedLattice_618 v0
  = case coe v0 of
      C_BoundedLattice'46'constructor_12089 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_boundedJoinSemilattice_684 v0
  = coe
      C_BoundedJoinSemilattice'46'constructor_1863
...
du_boundedMeetSemilattice_686 v0
  = coe
      C_BoundedMeetSemilattice'46'constructor_5319
...
du_lattice_688 v0
  = coe
      C_Lattice'46'constructor_7199 (d__'8744'__610 (coe v0))
...
data T_HeytingAlgebra_708
  = C_HeytingAlgebra'46'constructor_15185 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny -> AgdaAny) AgdaAny AgdaAny
...
d__'8744'__740 v0
  = case coe v0 of
      C_HeytingAlgebra'46'constructor_15185 v4 v5 v6 v7 v8 v9 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.HeytingAlgebra._∧_
d__'8743'__742 ::
  T_HeytingAlgebra_708 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__742 v0
  = case coe v0 of
      C_HeytingAlgebra'46'constructor_15185 v4 v5 v6 v7 v8 v9 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.HeytingAlgebra._⇨_
d__'8680'__744 ::
  T_HeytingAlgebra_708 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8680'__744 v0
  = case coe v0 of
      C_HeytingAlgebra'46'constructor_15185 v4 v5 v6 v7 v8 v9 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.HeytingAlgebra.⊤
d_'8868'_746 :: T_HeytingAlgebra_708 -> AgdaAny
d_'8868'_746 v0
  = case coe v0 of
      C_HeytingAlgebra'46'constructor_15185 v4 v5 v6 v7 v8 v9 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.HeytingAlgebra.⊥
d_'8869'_748 :: T_HeytingAlgebra_708 -> AgdaAny
d_'8869'_748 v0
  = case coe v0 of
      C_HeytingAlgebra'46'constructor_15185 v4 v5 v6 v7 v8 v9 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isHeytingAlgebra_750 v0
  = case coe v0 of
      C_HeytingAlgebra'46'constructor_15185 v4 v5 v6 v7 v8 v9 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_boundedLattice_752 v0
  = coe
      C_BoundedLattice'46'constructor_12089 (d__'8744'__740 (coe v0))
...
data T_BooleanAlgebra_850
  = C_BooleanAlgebra'46'constructor_18521 (AgdaAny ->
                                           AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
                                          AgdaAny AgdaAny
...
d__'8744'__882 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_18521 v4 v5 v6 v7 v8 v9 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BooleanAlgebra._∧_
d__'8743'__884 ::
  T_BooleanAlgebra_850 -> AgdaAny -> AgdaAny -> AgdaAny
d__'8743'__884 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_18521 v4 v5 v6 v7 v8 v9 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BooleanAlgebra.¬_
d_'172'__886 :: T_BooleanAlgebra_850 -> AgdaAny -> AgdaAny
d_'172'__886 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_18521 v4 v5 v6 v7 v8 v9 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BooleanAlgebra.⊤
d_'8868'_888 :: T_BooleanAlgebra_850 -> AgdaAny
d_'8868'_888 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_18521 v4 v5 v6 v7 v8 v9 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Lattice.Bundles.BooleanAlgebra.⊥
d_'8869'_890 :: T_BooleanAlgebra_850 -> AgdaAny
d_'8869'_890 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_18521 v4 v5 v6 v7 v8 v9 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isBooleanAlgebra_892 v0
  = case coe v0 of
      C_BooleanAlgebra'46'constructor_18521 v4 v5 v6 v7 v8 v9 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_heytingAlgebra_898 v0
  = coe
      C_HeytingAlgebra'46'constructor_15185 (d__'8744'__882 (coe v0))
