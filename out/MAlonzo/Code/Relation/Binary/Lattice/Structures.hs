...
data T_IsJoinSemilattice_22
  = C_IsJoinSemilattice'46'constructor_329 MAlonzo.Code.Relation.Binary.Structures.T_IsPartialOrder_162
                                           (AgdaAny ->
...
d_isPartialOrder_30 v0
  = case coe v0 of
      C_IsJoinSemilattice'46'constructor_329 v1 v2 -> coe v1
...
d_supremum_32 v0
  = case coe v0 of
      C_IsJoinSemilattice'46'constructor_329 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsBoundedJoinSemilattice_110
  = C_IsBoundedJoinSemilattice'46'constructor_4051 T_IsJoinSemilattice_22
                                                   (AgdaAny -> AgdaAny)
...
d_isJoinSemilattice_120 v0
  = case coe v0 of
      C_IsBoundedJoinSemilattice'46'constructor_4051 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_minimum_122 v0
  = case coe v0 of
      C_IsBoundedJoinSemilattice'46'constructor_4051 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsMeetSemilattice_168
  = C_IsMeetSemilattice'46'constructor_6037 MAlonzo.Code.Relation.Binary.Structures.T_IsPartialOrder_162
                                            (AgdaAny ->
                                             AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_isPartialOrder_176 v0
  = case coe v0 of
      C_IsMeetSemilattice'46'constructor_6037 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_infimum_178 v0
  = case coe v0 of
      C_IsMeetSemilattice'46'constructor_6037 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsBoundedMeetSemilattice_256
  = C_IsBoundedMeetSemilattice'46'constructor_9759 T_IsMeetSemilattice_168
                                                   (AgdaAny -> AgdaAny)
...
d_isMeetSemilattice_266 v0
  = case coe v0 of
      C_IsBoundedMeetSemilattice'46'constructor_9759 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maximum_268 v0
  = case coe v0 of
      C_IsBoundedMeetSemilattice'46'constructor_9759 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsLattice_316
  = C_IsLattice'46'constructor_11935 MAlonzo.Code.Relation.Binary.Structures.T_IsPartialOrder_162
                                     (AgdaAny -> AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
                                     (AgdaAny -> AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_isPartialOrder_328 v0
  = case coe v0 of
      C_IsLattice'46'constructor_11935 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_supremum_330 v0
  = case coe v0 of
      C_IsLattice'46'constructor_11935 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_infimum_332 v0
  = case coe v0 of
      C_IsLattice'46'constructor_11935 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isJoinSemilattice_334 v0
  = coe
      C_IsJoinSemilattice'46'constructor_329
...
du_isMeetSemilattice_336 v0
  = coe
      C_IsMeetSemilattice'46'constructor_6037
...
data T_IsDistributiveLattice_390
  = C_IsDistributiveLattice'46'constructor_14667 T_IsLattice_316
                                                 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_isLattice_400 v0
  = case coe v0 of
      C_IsDistributiveLattice'46'constructor_14667 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_'8743''45'distrib'737''45''8744'_402 v0
  = case coe v0 of
      C_IsDistributiveLattice'46'constructor_14667 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isBoundedJoinSemilattice_542 v0
  = coe
      C_IsBoundedJoinSemilattice'46'constructor_4051
      (coe du_isJoinSemilattice_334 (coe d_isLattice_482 (coe v0)))
...
du_isBoundedMeetSemilattice_544 v0
  = coe
      C_IsBoundedMeetSemilattice'46'constructor_9759
      (coe du_isMeetSemilattice_336 (coe d_isLattice_482 (coe v0)))
...
data T_IsHeytingAlgebra_556
  = C_IsHeytingAlgebra'46'constructor_20703 T_IsBoundedLattice_466
                                            (AgdaAny ->
                                             AgdaAny ->
                                             AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_isBoundedLattice_572 v0
  = case coe v0 of
      C_IsHeytingAlgebra'46'constructor_20703 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_exponential_574 v0
  = case coe v0 of
      C_IsHeytingAlgebra'46'constructor_20703 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
newtype T_IsBooleanAlgebra_682
  = C_IsBooleanAlgebra'46'constructor_25999 T_IsHeytingAlgebra_556
...
d_isHeytingAlgebra_708 v0
  = case coe v0 of
      C_IsBooleanAlgebra'46'constructor_25999 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
