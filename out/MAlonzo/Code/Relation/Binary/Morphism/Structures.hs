...
data T_IsRelIsomorphism_94
  = C_IsRelIsomorphism'46'constructor_2169 T_IsRelMonomorphism_64
...
d_isMonomorphism_106 v0
  = case coe v0 of
      C_IsRelIsomorphism'46'constructor_2169 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_108 v0
  = case coe v0 of
      C_IsRelIsomorphism'46'constructor_2169 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsOrderHomomorphism_138
  = C_IsOrderHomomorphism'46'constructor_4003 (AgdaAny ->
                                               AgdaAny -> AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_cong_154 v0
  = case coe v0 of
      C_IsOrderHomomorphism'46'constructor_4003 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_mono_156 v0
  = case coe v0 of
      C_IsOrderHomomorphism'46'constructor_4003 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsOrderMonomorphism_182
  = C_IsOrderMonomorphism'46'constructor_6709 T_IsOrderHomomorphism_138
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_isOrderHomomorphism_200 v0
  = case coe v0 of
      C_IsOrderMonomorphism'46'constructor_6709 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_injective_202 v0
  = case coe v0 of
      C_IsOrderMonomorphism'46'constructor_6709 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_cancel_204 v0
  = case coe v0 of
      C_IsOrderMonomorphism'46'constructor_6709 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsOrderIsomorphism_238
  = C_IsOrderIsomorphism'46'constructor_10541 T_IsOrderMonomorphism_182
                                              (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_isOrderMonomorphism_254 v0
  = case coe v0 of
      C_IsOrderIsomorphism'46'constructor_10541 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_256 v0
  = case coe v0 of
      C_IsOrderIsomorphism'46'constructor_10541 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isRelIsomorphism_276 v0
  = coe
      C_IsRelIsomorphism'46'constructor_2169
      (coe
