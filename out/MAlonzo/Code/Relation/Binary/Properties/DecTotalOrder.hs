...
d_invIsPreorder_178 ~v0 ~v1 ~v2 v3 = du_invIsPreorder_178 v3
du_invIsPreorder_178 ::
  MAlonzo.Code.Relation.Binary.Bundles.T_DecTotalOrder_736 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsPreorder_70
du_invIsPreorder_178 v0
  = let v1
          = coe
              MAlonzo.Code.Relation.Binary.Bundles.du_totalOrder_812 (coe v0) in
    let v2
...
du_'8805''45'isTotalOrder_180 v0
  = coe
      MAlonzo.Code.Relation.Binary.Properties.TotalOrder.du_'8805''45'isTotalOrder_192
      (coe
...
d_invPreorder_184 ~v0 ~v1 ~v2 v3 = du_invPreorder_184 v3
du_invPreorder_184 ::
  MAlonzo.Code.Relation.Binary.Bundles.T_DecTotalOrder_736 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_Preorder_132
du_invPreorder_184 v0
  = let v1
          = coe
              MAlonzo.Code.Relation.Binary.Bundles.du_totalOrder_812 (coe v0) in
    let v2
...
du_'8805''45'totalOrder_192 v0
  = coe
      MAlonzo.Code.Relation.Binary.Properties.TotalOrder.du_'8805''45'totalOrder_194
      (coe
         MAlonzo.Code.Relation.Binary.Bundles.du_totalOrder_812 (coe v0))
-- Relation.Binary.Properties.DecTotalOrder.TotalOrderProperties.trans
d_trans_194 ::
...
du_'8816''8658''62'_200 v0
  = coe
      MAlonzo.Code.Relation.Binary.Properties.TotalOrder.du_'8816''8658''62'_204
      (coe
         MAlonzo.Code.Relation.Binary.Bundles.du_totalOrder_812 (coe v0))
-- Relation.Binary.Properties.DecTotalOrder.TotalOrderProperties.≰⇒≥
...
du_'8816''8658''8805'_202 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Relation.Binary.Properties.TotalOrder.du_'8816''8658''8805'_210
      (coe
         MAlonzo.Code.Relation.Binary.Bundles.du_totalOrder_812 (coe v0))
      v1 v2
...
du_'8814''8658''8805'_224 v0 v1 v2 v3
  = coe
      ...
      (coe v1) (coe v2)
-- Relation.Binary.Properties.DecTotalOrder.strictTotalOrder
d_strictTotalOrder_226 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_DecTotalOrder_736 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_StrictTotalOrder_860
d_strictTotalOrder_226 ~v0 ~v1 ~v2 v3 = du_strictTotalOrder_226 v3
du_strictTotalOrder_226 ::
  MAlonzo.Code.Relation.Binary.Bundles.T_DecTotalOrder_736 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_StrictTotalOrder_860
du_strictTotalOrder_226 v0
  = coe du_'60''45'strictTotalOrder_214 (coe v0)
