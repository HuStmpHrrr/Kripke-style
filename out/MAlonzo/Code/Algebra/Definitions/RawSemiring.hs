...
du__'215'__40 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Algebra.Bundles.du_'43''45'rawMonoid_1330
         (coe
            MAlonzo.Code.Algebra.Bundles.du_rawNearSemiring_1702 (coe v0)))
-- Algebra.Definitions.RawSemiring._._×′_
d__'215''8242'__42 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
du__'215''8242'__42 v0
  = let v1
          = coe
              MAlonzo.Code.Algebra.Bundles.du_'43''45'rawMonoid_1330
              (coe
                 MAlonzo.Code.Algebra.Bundles.du_rawNearSemiring_1702 (coe v0)) in
    coe
      (\ v2 v3 ->
         let v4 = subInt (coe v2) (coe (1 :: Integer)) in
         let v5
               = coe
                   MAlonzo.Code.Algebra.Bundles.d__'8729'__420 v1
                   (coe
                      MAlonzo.Code.Algebra.Definitions.RawMonoid.du__'215''8242'__52
                      (coe v1) (coe v4) (coe v3))
                   v3 in
         case coe v2 of
           0 -> coe MAlonzo.Code.Algebra.Bundles.d_ε_422 (coe v1)
           1 -> coe v3
           _ -> coe v5)
...
du_sum_68 v0
  = coe
      MAlonzo.Code.Algebra.Definitions.RawMonoid.du_sum_64
      (coe
         MAlonzo.Code.Algebra.Bundles.du_'42''45'rawMonoid_1714 (coe v0))
...
du__'94''8242'__76 v0 v1 v2
  = let v3
          = coe
              MAlonzo.Code.Algebra.Bundles.du_'42''45'rawMonoid_1714 (coe v0) in
    let v4 = subInt (coe v2) (coe (1 :: Integer)) in
    let v5
          = coe
              MAlonzo.Code.Algebra.Bundles.d__'8729'__420 v3
              (coe
                 MAlonzo.Code.Algebra.Definitions.RawMonoid.du__'215''8242'__52
                 (coe v3) (coe v4) (coe v1))
              v1 in
    case coe v2 of
      0 -> coe MAlonzo.Code.Algebra.Bundles.d_ε_422 (coe v3)
      1 -> coe v1
      _ -> coe v5
-- Algebra.Definitions.RawSemiring._^[_]*_
  ...
  = case coe v2 of
      ...
      _ -> let v4 = subInt (coe v2) (coe (1 :: Integer)) in
           coe
             ...
             (coe MAlonzo.Code.Algebra.Bundles.d__'42'__1696 v0 v1 v3)
...
d_p'8777'0_148 ::
  T_Prime_134 -> AgdaAny -> MAlonzo.Code.Data.Empty.T_'8869'_4
