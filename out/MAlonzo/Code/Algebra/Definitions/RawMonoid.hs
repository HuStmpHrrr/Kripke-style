...
du__'215'__44 v0 v1 v2
  = case coe v1 of
      0 -> coe MAlonzo.Code.Algebra.Bundles.d_ε_422 (coe v0)
      _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
           coe
             MAlonzo.Code.Algebra.Bundles.d__'8729'__420 v0 v2
...
du__'215''8242'__52 v0 v1 v2
  = let v3 = subInt (coe v1) (coe (1 :: Integer)) in
    let v4
          = coe
              MAlonzo.Code.Algebra.Bundles.d__'8729'__420 v0
...
du_sum_64 v0 v1
  = coe
      ...
      (coe MAlonzo.Code.Algebra.Bundles.d__'8729'__420 (coe v0))
      (coe MAlonzo.Code.Algebra.Bundles.d_ε_422 (coe v0)) (coe v1)
