...
d_0H_228 ::
  ...
  MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.T_AlmostCommutativeRing_178 ->
  (AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T_Dec_32) ->
  Integer -> MAlonzo.Code.Algebra.Solver.Ring.T_HNF_444
d_0H_228 ~v0 ~v1 ~v2 ~v3 ~v4 = du_0H_228
du_0H_228 :: MAlonzo.Code.Algebra.Solver.Ring.T_HNF_444
du_0H_228 = coe MAlonzo.Code.Algebra.Solver.Ring.C_'8709'_450
...
d_normalise'45'con_272 ::
  ...
  MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.T_AlmostCommutativeRing_178 ->
  (AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T_Dec_32) ->
  Integer -> AgdaAny -> MAlonzo.Code.Algebra.Solver.Ring.T_Normal_446
...
d_'10214'_'10215'H'45'cong_300 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Algebra.Solver.Ring.d_'10214'_'10215'H'45'cong_614
      (coe v0) (coe v0) (coe v1) (coe v1)
      (coe
         MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.du_rawRing_344
         (coe v2))
...
d_'10214'_'10215'N'45'cong_304 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Algebra.Solver.Ring.d_'10214'_'10215'N'45'cong_624
      (coe v0) (coe v0) (coe v1) (coe v1)
      (coe
         MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.du_rawRing_344
         (coe v2))
