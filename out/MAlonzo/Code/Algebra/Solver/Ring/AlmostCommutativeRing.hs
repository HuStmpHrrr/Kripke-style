...
data T_IsAlmostCommutativeRing_26
  = C_IsAlmostCommutativeRing'46'constructor_587 MAlonzo.Code.Algebra.Structures.T_IsCommutativeSemiring_1244
...
data T_AlmostCommutativeRing_178
  = C_AlmostCommutativeRing'46'constructor_5201 (AgdaAny ->
                                                 AgdaAny -> AgdaAny)
                                                (AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
...
d__'43'__204 v0
  = case coe v0 of
      C_AlmostCommutativeRing'46'constructor_5201 v3 v4 v5 v6 v7 v8
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._*_
d__'42'__206 ::
...
du_'42''45'commutativeMonoid_324 v0
  = coe
      MAlonzo.Code.Algebra.Bundles.du_'42''45'commutativeMonoid_2208
...
du_commutativeSemigroup_326 v0
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    coe
      MAlonzo.Code.Algebra.Bundles.du_commutativeSemigroup_668
      (coe
         MAlonzo.Code.Algebra.Bundles.du_'42''45'commutativeMonoid_2208
         (coe v1))
...
du_magma_328 v0
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    let v2
          = coe MAlonzo.Code.Algebra.Bundles.du_semiring_2166 (coe v1) in
    let v3
          = coe
    ...
    let v4
          = coe
              MAlonzo.Code.Algebra.Bundles.du_'42''45'monoid_1854 (coe v3) in
    coe
      MAlonzo.Code.Algebra.Bundles.du_magma_254
      (coe MAlonzo.Code.Algebra.Bundles.du_semigroup_564 (coe v4))
  ...
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    ...
    let v3
          = coe
              ...
              (coe v2) in
    coe
      MAlonzo.Code.Algebra.Bundles.du_semigroup_564
      (coe MAlonzo.Code.Algebra.Bundles.du_'42''45'monoid_1854 (coe v3))
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._.+-commutativeMonoid
...
du_'43''45'commutativeMonoid_334 v0
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    let v2
          = coe MAlonzo.Code.Algebra.Bundles.du_semiring_2166 (coe v1) in
    coe
      MAlonzo.Code.Algebra.Bundles.du_'43''45'commutativeMonoid_1832
      (coe
         MAlonzo.Code.Algebra.Bundles.du_semiringWithoutAnnihilatingZero_1988
         (coe v2))
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._.magma
  ...
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    ...
    let v4
          = coe
              MAlonzo.Code.Algebra.Bundles.du_'43''45'commutativeMonoid_1832
              (coe v3) in
    let v5 = coe MAlonzo.Code.Algebra.Bundles.du_monoid_652 (coe v4) in
    coe
      MAlonzo.Code.Algebra.Bundles.du_magma_254
...
du_semigroup_340 v0
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    ...
    coe
      MAlonzo.Code.Algebra.Bundles.du_semigroup_564
      (coe MAlonzo.Code.Algebra.Bundles.du_monoid_652 (coe v4))
...
du_rawRing_344 v0
  = coe
      MAlonzo.Code.Algebra.Bundles.C_RawRing'46'constructor_39345
      (d__'43'__204 (coe v0)) (d__'42'__206 (coe v0))
...
data T__'45'Raw'45'AlmostCommutative'10230'__358
  = C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_8311 (AgdaAny ->
                                                                 AgdaAny)
                                                                (AgdaAny -> AgdaAny -> AgdaAny)
                                                                (AgdaAny -> AgdaAny -> AgdaAny)
                                                                (AgdaAny -> AgdaAny) AgdaAny AgdaAny
...
du__'42'__374 ::
  ...
  AgdaAny -> AgdaAny -> AgdaAny
du__'42'__374 v0
  = coe MAlonzo.Code.Algebra.Bundles.d__'42'__2584 (coe v0)
-- Algebra.Solver.Ring.AlmostCommutativeRing.F._+_
d__'43'__376 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
du__'43'__376 ::
  ...
  AgdaAny -> AgdaAny -> AgdaAny
du__'43'__376 v0
  = coe MAlonzo.Code.Algebra.Bundles.d__'43'__2582 (coe v0)
...
du_0'35'_394 ::
  MAlonzo.Code.Algebra.Bundles.T_RawRing_2558 -> AgdaAny
du_0'35'_394 v0
  = coe MAlonzo.Code.Algebra.Bundles.d_0'35'_2588 (coe v0)
...
du_1'35'_396 ::
  MAlonzo.Code.Algebra.Bundles.T_RawRing_2558 -> AgdaAny
du_1'35'_396 v0
  = coe MAlonzo.Code.Algebra.Bundles.d_1'35'_2590 (coe v0)
...
d_'10214'_'10215'_752 v0
  = case coe v0 of
      C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_8311 v1 v2 v3 v4 v5 v6
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_'45'raw'45'almostCommutative'10230'_770 v0
  = coe
      C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_8311
      (coe (\ v1 -> v1))
      (coe
         (\ v1 v2 ->
            coe
              ...
              (let v3 = coe du_rawRing_344 (coe v0) in
               coe MAlonzo.Code.Algebra.Bundles.d__'43'__2582 v3 v1 v2)))
      (coe
         (\ v1 v2 ->
            coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe d_isAlmostCommutativeRing_214 (coe v0))))))))))
              (let v3 = coe du_rawRing_344 (coe v0) in
               coe MAlonzo.Code.Algebra.Bundles.d__'42'__2584 v3 v1 v2)))
      (coe
         (\ v1 ->
            coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
              ...
              (let v2 = coe du_rawRing_344 (coe v0) in
               coe MAlonzo.Code.Algebra.Bundles.d_'45'__2586 v2 v1)))
      (coe
         MAlonzo.Code.Relation.Binary.Structures.d_refl_34
         (MAlonzo.Code.Algebra.Structures.d_isEquivalence_106
            (coe
         ...
         (let v1 = coe du_rawRing_344 (coe v0) in
          MAlonzo.Code.Algebra.Bundles.d_0'35'_2588 (coe v1)))
      (coe
         MAlonzo.Code.Relation.Binary.Structures.d_refl_34
         (MAlonzo.Code.Algebra.Structures.d_isEquivalence_106
            (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe d_isAlmostCommutativeRing_214 (coe v0))))))))))
         (let v1 = coe du_rawRing_344 (coe v0) in
          MAlonzo.Code.Algebra.Bundles.d_1'35'_2590 (coe v1)))
...
d_isCommutativeMagma_986 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsCommutativeMagma_134
...
d_'42''45'isMagma_992 ::
  ...
  T_AlmostCommutativeRing_178 ->
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsMagma_98
...
d_'42''45'isSemigroup_996 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsSemigroup_206
...
d_commutativeSemiring_1056 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Bundles.T_CommutativeSemiring_2036
...
d_isNearSemiring_1072 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsNearSemiring_826
...
d_isSemiring_1076 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsSemiring_1136
...
d_rawRing_1082 ::
  ...
  T_AlmostCommutativeRing_178 ->
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Algebra.Bundles.T_RawRing_2558
...
d_semiring_1088 ::
  ...
  T_AlmostCommutativeRing_178 ->
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Algebra.Bundles.T_Semiring_1870
...
du_fromCommutativeRing_1120 v0
  = coe
      C_AlmostCommutativeRing'46'constructor_5201
      (MAlonzo.Code.Algebra.Bundles.d__'43'__2840 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d__'42'__2842 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_'45'__2844 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_0'35'_2846 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_1'35'_2848 (coe v0))
      (coe
         C_IsAlmostCommutativeRing'46'constructor_587
         (coe
            MAlonzo.Code.Algebra.Structures.du_isCommutativeSemiring_1884
            (coe
               MAlonzo.Code.Algebra.Bundles.d_isCommutativeRing_2850 (coe v0)))
         (coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe
                        MAlonzo.Code.Algebra.Bundles.d_isCommutativeRing_2850 (coe v0))))))
         (coe
            MAlonzo.Code.Algebra.Properties.Ring.du_'45''8255''42''45'distrib'737'_270
            (coe MAlonzo.Code.Algebra.Bundles.du_ring_2974 (coe v0)))
         (coe
...
d_fromCommutativeSemiring_1414 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Algebra.Bundles.T_CommutativeSemiring_2036 ->
  T_AlmostCommutativeRing_178
d_fromCommutativeSemiring_1414 ~v0 ~v1 v2
  = du_fromCommutativeSemiring_1414 v2
du_fromCommutativeSemiring_1414 ::
  MAlonzo.Code.Algebra.Bundles.T_CommutativeSemiring_2036 ->
  T_AlmostCommutativeRing_178
du_fromCommutativeSemiring_1414 v0
  = coe
      C_AlmostCommutativeRing'46'constructor_5201
      (MAlonzo.Code.Algebra.Bundles.d__'43'__2060 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d__'42'__2062 (coe v0)) (\ v1 -> v1)
      (MAlonzo.Code.Algebra.Bundles.d_0'35'_2064 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_1'35'_2066 (coe v0))
      (coe
         C_IsAlmostCommutativeRing'46'constructor_587
         (coe
            MAlonzo.Code.Algebra.Bundles.d_isCommutativeSemiring_2068 (coe v0))
         (coe (\ v1 v2 v3 -> v3))
         (coe
            (\ v1 v2 ->
               coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      MAlonzo.Code.Algebra.Structures.d_isSemiring_1258
                                      (coe
                                         MAlonzo.Code.Algebra.Bundles.d_isCommutativeSemiring_2068
                                         (coe v0)))))))))
                 (coe MAlonzo.Code.Algebra.Bundles.d__'42'__2062 v0 v1 v2)))
         (coe
            (\ v1 v2 ->
               coe
                 MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.Algebra.Bundles.d_isCommutativeSemiring_2068
                                         (coe v0)))))))))
                 (coe MAlonzo.Code.Algebra.Bundles.d__'43'__2060 v0 v1 v2))))
